    ...
    return (
        ...
        <div className={styles.contLogin}>
            <form className={styles.logForm} onSubmit={(e) => {e.preventDefault()}}>
                ...
                <input type="button" className={styles.logInput} id="reg" value="Register" onClick={changeShowRegister}/>
                <input type="submit" className={styles.logInput} id="submit" value="Login" onClick={loginUser}/>
            </form>
        </div>
        </>
    ) ;
